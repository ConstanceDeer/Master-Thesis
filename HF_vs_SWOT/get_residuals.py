...
# Avg of points with 24 valid hour data. 
...
for t in hf_dates:
    ...
    # ----------------------------
    # Find SWOT data within the date
    ...
    # ----------------------------
    # interpolation, mean of four nearest where distance < 5km
